...
export default function Register() {
    ...
    try {
      ...
      if (result?.requires_verification) {
        if (result?.dev_otp) {
          ...
          toast({ title: "Development verification code", description: result.dev_otp });
        }
        setShowOtp(true);
      } else {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      if (result?.dev_otp) setOtpCode(result.dev_otp);
      toast({
        title: "Code sent",
        description: result?.dev_otp ? `Development code: ${result.dev_otp}` : "Check your email for the new code.",
      });
    } catch (err) {
